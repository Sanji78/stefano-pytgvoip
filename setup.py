...
setup(
    ...
    url='https://github.com/Sanji78/stefano-pytgvoip',
    keywords='telegram messenger voip library python',
    project_urls={
        'Tracker': 'https://github.com/Sanji78/stefano-pytgvoip/issues',
        'Source': 'https://github.com/Sanji78/stefano-pytgvoip',
    },
    python_requires='>=3.8',
    ext_modules=[CMakeExtension('tgvoip._tgvoip', sourcedir='')],
